...
String newsContent2 = "";
String newsContent3 = "";
    Document doc = Jsoup.connect("https://www.ccn.com/?s=Construction industry").get();
...
<div class="mySlides fade">
  ...
  <p id="send_text" style=" opacity: 0.5;"><%=newsContent.substring(0,newsContent.indexOf(".")+1)%> </p>
  ...
  <div id="plain" style="position:relative; float:right; display: none"><p id="send_text2" style=" opacity: 0.5;"><%=newsContent.substring(newsContent.indexOf(".")+1)%></p></div>
...
<div class="mySlides fade">
  ...
  <div id="plain2" style="position:relative; float:right; display: none"><p style=" opacity: 0.5;"><%=newsContent2.substring(newsContent2.indexOf(".")+1)%></p></div>
...
<div class="mySlides fade">
  ...
  <div id="plain3" style="position:relative; float:right; display: none"><p style=" opacity: 0.5;"><%=newsContent3.substring(newsContent3.indexOf(".")+1)%></p></div>
...
<br>
<button id="jsonConvertStringSend" type="button" style="display: block; margin: 0 auto;"> 번역하기 </button>
<br>
<div style="display:flex; justify-content: center;">
<textarea  id="result_text" class="form-control" name="content" rows="5" placeholder="위에 '번역하기'버튼을 눌러주시면 한글로 번역됩니다." style=" overflow:visible; width:100%; height: auto;"></textarea>
</div>
<script>
var slideIndex = 1;
