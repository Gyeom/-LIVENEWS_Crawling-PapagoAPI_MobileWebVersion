...
<body>
	<%
		...
		String newsContent2 = "";
		String newsContent3 = "";
		Document doc = Jsoup.connect("https://www.ccn.com/?s=Manufacturing industry").get();
	...
	<button id="jsonConvertStringSend" type="button"
		style="display: block; margin: 0 auto; border-radius: 12px; font-weight:bold">▼ 번역하기 </button>
	<br>
